...
def control_structure():
    ...
    for i, trial in enumerate(trial_sequence):
        ...
        if trial == 'A':
            print("Angle A")
            memory_angle_difference = memory_angleA_difference      #TODO: TEST RUN THIS CODE, CONDENSED VERSION IS UNTESTED
        elif trial == 'B':
            print("Angle B")
        ...
        exo.enable_motor(motor_id=motorID)
        targetAngle = get_latest_imu_angle()["yaw"] + memory_angle_difference
