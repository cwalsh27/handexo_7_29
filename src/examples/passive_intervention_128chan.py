...
stream_name_1 = 'FLEX'     #TODO: vary stream name so that we don't pick up the wrong device       # Search for active stream names using names_of_active_lsl_streams.py and connect to NML wifi
stream_name_2 = 'EXT'
...
def control_structure():
    ...
    _, extension_timestamp = inlet1.pull_sample()
    ...
    for i in range(trial_count):
        _, flexion_timestamp = inlet1.pull_sample()
